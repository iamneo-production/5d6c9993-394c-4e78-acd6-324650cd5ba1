  ...
  const Card1= ({ title1, description1,des1, imageUrl1, isActive }) => {
    return (
      <div style={{ ...styles.card1, backgroundColor: isActive ? 'lightblue' : 'white' }}>
        ...
        <div clasName="tata">
        <div className="ding1">
       <a href="https://docs.google.com/forms/d/e/1FAIpQLSeU2zsvhLpcu9F5rSe_ULg2vWZ-sgknaOqD0hiR--4SxmlItw/viewform?usp=sf_link">
       <center><button type="submit">Take Test</button></center></a>
       </div>
       </div>
      </div>
    );
